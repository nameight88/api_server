  ...
  res.json({
    ...
    endpoints: {
      ...
      employees: {
        ...
        byEmployeeNo: 'GET /api/employees/:employee_no',
        active: 'GET /api/employees/status/active',
        byBatchStatus: 'GET /api/employees/batch-status/:status',
        byCardType: 'GET /api/employees/card-type/:type',
        search: 'GET /api/employees/search?q=searchTerm',
